...
import 'expense_tracker_expense_create_expense_select_category_modal_content/expense_tracker_expense_create_expense_select_category_modal_content.dart';
import 'expense_tracker_expense_create_expense_select_category_modal_controller.dart';
import 'expense_tracker_expense_create_expense_select_category_modal_cubit.dart';
import 'expense_tracker_expense_create_expense_select_category_modal_data.dart';


class ExpenseTrackerExpenseCreateExpenseSelectCategoryModal
    extends BaseModalWidget<
        ExpenseTrackerExpenseCreateExpenseSelectCategoryModalController,
  ...
  @override
  ExpenseTrackerExpenseCreateExpenseSelectCategoryModalCubit createCubitAndAssignToController(
      BuildContext context) {
    ExpenseTrackerExpenseCreateExpenseSelectCategoryModalCubit cubit = ExpenseTrackerExpenseCreateExpenseSelectCategoryModalCubit(
        context: context);
  ...
  Widget getModalContentWidget({required BuildContext context}) {
    return ExpenseTrackerExpenseCreateExpenseSelectCategoryModalContent();
  }
}
